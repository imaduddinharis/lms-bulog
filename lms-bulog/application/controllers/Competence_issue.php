 ...
 */
class Competence_issue extends CI_Controller {
...
//		$this->load->library('template');
	...
	public function index()
	{
        ...
        $data['title']= 'Manage Competence Issue';
        ...
        $data['container']=$this->load->view('content/parameter/competence-issue-home',$data, true);
