 ...
 */
class Strategic_innitiative extends CI_Controller {
...
//		$this->load->library('template');
	...
	public function index()
	{
        ...
        $data['title']= 'Manage Strategic Innitiative';
        ...
        $data['container']=$this->load->view('content/parameter/strategic-innitiative-home',$data, true);
