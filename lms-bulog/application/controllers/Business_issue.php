 ...
 */
class Business_issue extends CI_Controller {
...
//		$this->load->library('template');
	...
	public function index()
	{
        ...
        $data['title']= 'Manage Business Issue';
        ...
        $data['container']=$this->load->view('content/parameter/business-issue-home',$data, true);
