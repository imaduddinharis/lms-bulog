...
<!--                                                            <h4 class="sub-title">Basic Inputs</h4>-->
                                                            <form method="post" action="<?=base_url()?>add-diklat">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Kode Diklat</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" placeholder="masukkan kode diklat" name="kode_diklat">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Nama Diklat</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" placeholder="masukkan nama diklat" name="nama_diklat">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" placeholder="masukkan master plan" name="master_plan">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-10">
                                                                        <button name="submit" type="submit" class="btn btn-primary">Add Diklat</button>
                                                                    </div>
                                                                </div>
                                                                </form>
                                                                            </div>
