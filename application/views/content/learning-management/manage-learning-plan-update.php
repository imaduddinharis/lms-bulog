...
<!--                                                            <h4 class="sub-title">Basic Inputs</h4>-->
                                                            <form method="post" action="<?=base_url()?>update-learning-plan">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Kode LP</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" placeholder="masukkan kode learning plan" name="kode_lp" value="<?=$lp->kode_lp?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">Pilih Diklat</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="diklat" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="akademi" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="performance_issue" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="strategic_innitiative" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="business_issue" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="competence_issue" class="form-control" required>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="date" class="form-control" name="tgl_mulai" value="<?=$lp->tgl_mulai?>" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="date" class="form-control" name="tgl_selesai"value="<?=$lp->tgl_selesai?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Tahun</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" name="tahun"value="<?=$lp->tahun?>" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="total_anggaran" name="total_anggaran"value="<?=$lp->total_anggaran?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-10">
                                                                        <button onclick="checkNumber()" name="update" type="submit" class="btn btn-primary">Update Learning Plan</button>
                                                                    </div>
                                                                </div>
                                                                </form>
                                                                            </div>
